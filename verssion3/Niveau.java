...
public class Niveau {
    ...
    if(sortie_nord!=null){
        if(sortie_nord.equals(p))
        return true;
    }
    if(sortie_est!=null){
        if(sortie_est.equals(p))
        return true;
    }
    if(sortie_sud!=null){
        if(sortie_sud.equals(p))
        return true;
    }
    if(sortie_ouest!=null)
        return sortie_ouest.equals(p);
    return false;
    ...
    public boolean sud(Position p){
        if(sortie_sud==null)
            return false;
        return sortie_sud.equals(p);
    }
    public boolean nord(Position p){
        if(sortie_nord==null)
            return false;
        return sortie_nord.equals(p);
    }
    public boolean est(Position p){
        if(sortie_est==null)
            return false;
        return sortie_est.equals(p);
    }
    public boolean ouest(Position p){
        if(sortie_ouest==null)
            return false;
        return sortie_ouest.equals(p);
    }
