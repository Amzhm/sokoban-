...
public static void main(String[] args) {
	...
	n = clavier.nextInt();
	while(true){
		Configuration c=ChargerFichier("./verssion3.1/verssion3/jeux2.txt",n);
      	jouer(c);
            ...
            switch(s){
                case 5:
					...
					case 0:
						...
						break;
					case 7:
						sokoban=ChargerFichier("./verssion3.1/verssion3/jeux2.txt",n);
		...
		for (String line : n.split("\n")){
			for (int i=0;i<line.length();i++){
				...
				case '^':
					...
					break;
				case '1':
					joueur=ChargerFichier("./verssion3.1/verssion3/jeux2.txt", 1);
						joueur.setType(Type.JOUEUR);
						posjoueur=new Position(j,i);
						break;
				case '2':
					caisses.add(ChargerFichier("./verssion3.1/verssion3/jeux2.txt", 2));
					poscaisses.add(new Position(j,i));
					break;
				case '3':
					caisses.add(ChargerFichier("./verssion3.1/verssion3/jeux2.txt", 3));
					poscaisses.add(new Position(j,i));
					break;
				case '4':
					caisses.add(ChargerFichier("./verssion3.1/verssion3/jeux2.txt", 4));
					poscaisses.add(new Position(j,i));
					break;
				case '5':
					caisses.add(ChargerFichier("./verssion3.1/verssion3/jeux2.txt", 5));
					poscaisses.add(new Position(j,i));
					break;
				case '6':
					caisses.add(ChargerFichier("./verssion3.1/verssion3/jeux2.txt", 6));
					poscaisses.add(new Position(j,i));
					break;
				case '7':
					caisses.add(ChargerFichier("./verssion3.1/verssion3/jeux2.txt", 7));
					poscaisses.add(new Position(j,i));
					break;
				case '8':
					caisses.add(ChargerFichier("./verssion3.1/verssion3/jeux2.txt", 8));
					poscaisses.add(new Position(j,i));
					break;
				case '9':
					caisses.add(ChargerFichier("./verssion3.1/verssion3/jeux2.txt", 9));
					poscaisses.add(new Position(j,i));
					break;
				case '0':
