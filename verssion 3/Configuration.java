...
public class Configuration extends Mobile {
    ...
    public Configuration(Type t,Configuration c,Position p,Niveau n,Position posjoueur,Configuration m){
        super(t, c, p);
        caisses=new ArrayList<Caisse>();
        niveau=n;
        joueur=new Joueur(this, posjoueur);
        monde=m;
